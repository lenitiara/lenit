                    ...
                    <div class="card blue darken-1 white-text">
                        <div class="card-content">';
                            ...
                            if(!empty($data['nama'])){
                                ...
                                echo '<h5 class="ins">Fakultas Teknik Universitas Suryakancana</h5>';
                            }

                            if(!empty($data['alamat'])){
                                echo '<p class="almt">'.$data['alamat'].'</p>';
                            } else {
                                echo '<p class="almt">Jl. Pasir Gede Raya, Bojongherang, Kec. Cianjur, Kabupaten Cianjur, Jawa Barat 43216</p>';
                            }
                            echo '
                        </div>
                    </div>
