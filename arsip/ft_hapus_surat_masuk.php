            ...
            <!-- Row form END -->';
            	...
            	if(isset($_REQUEST['submit'])){
                    ...
                    if(!empty($row['file'])){
                        ...
                        $query = mysqli_query($koneksi, "DELETE FROM tbl_surat_masuk WHERE id_surat='$id_surat'");
                        $query2 = mysqli_query($koneksi, "DELETE FROM tbl_disposisi WHERE id_surat='$id_surat'");
