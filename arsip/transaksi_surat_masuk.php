                                    ...
                                    <div class="col m7">
                                        <ul class="left">
                                            ...
                                            <li class="waves-effect waves-light">
                                                <a href="?page=tsm&act=add"><i class="material-icons md-24">add_circle</i> Membuat Surat</a>
                                            </li>
                                        </ul>
                                    </div>
                ...
                <?php
                    ...
                    $cari = mysqli_real_escape_string($koneksi, $_REQUEST['cari']);
                        ...
                        <table class="bordered" id="tbl">
                            ...
                            $query = mysqli_query($koneksi, "SELECT * FROM tbl_surat_masuk WHERE no_surat LIKE '%$cari%' ORDER by id_surat DESC LIMIT 15");
                            $query = mysqli_query($koneksi, "SELECT * FROM tbl_surat_masuk WHERE isi LIKE '%$cari%' ORDER by id_surat DESC LIMIT 15");
                    ...
                    <!-- Row form END -->';
                        ...
                        <div class="col m12" id="colres">
                            <table class="bordered" id="tbl">
                                ...
                                $query = mysqli_query($koneksi, "SELECT * FROM tbl_surat_masuk ORDER by id_surat DESC LIMIT $curr, $limit");
                                if(mysqli_num_rows($query) > 0){
                                    $no = 1;
                                    while($row = mysqli_fetch_array($query)){
                                      echo '
                    ...
                    $query = mysqli_query($koneksi, "SELECT * FROM tbl_surat_masuk");
