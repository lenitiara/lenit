                            ...
                            <div class="row jarak-form">
                                ...
                                <div class="col m12" id="colres">
                                    <table class="bordered" id="tbl">
                                        ...
                                        $query2 = mysqli_query($koneksi, "SELECT * FROM tbl_disposisi JOIN tbl_surat_masuk ON tbl_disposisi.id_surat = tbl_surat_masuk.id_surat WHERE tbl_disposisi.id_surat='$id_surat'");
