                ...
                if(empty($pg)){
                            ...
                            <div class="z-depth-1">
                                <nav class="secondary-nav">
                                    <div class="nav-wrapper blue-grey darken-1">
                                        <div class="col m12">
                                            <ul class="left">
                                                <li class="waves-effect waves-light"><a href="?page=gsmf" class="judul"><i class="material-icons">image</i> Galeri File Surat Masuk</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </nav>
                    ...
                    if(isset($_REQUEST['submit'])){
                        ...
                        if($_REQUEST['dari_tanggal'] == "" || $_REQUEST['sampai_tanggal'] == ""){
                            header("Location: ./admin.php?page=gsmf");
                            die();
                        } else {

                        $query = mysqli_query($koneksi, "SELECT * FROM tbl_surat_masuk_ft WHERE tgl_diterima BETWEEN '$dari_tanggal' AND '$sampai_tanggal' ORDER By id_suratft DESC LIMIT 10");
                                    ...
                                    if(in_array($eks, $ekstensi) == true){
                                        echo '
                                            <div class="col m3">
                                                ...
                                                <a class="btn light-green darken-1" href="?page=gsmf&act=fsmf&id_suratft='.$row['id_suratft'].'">Tampilkan Ukuran Penuh</a>
                                            </div>';
                                    } else {
                                        ...
                                        if(in_array($eks, $ekstensi2) == true){
                                            echo '
                                                <div class="col m3">
                                                    ...
                                                    <a class="btn light-green darken-1" href="?page=gsmf&act=fsmf&id_suratft='.$row['id_suratft'].'">Lihat Detail File</a>
                                                </div>';
                                        } else {
                                            echo '
                                                <div class="col m3">
                                    ...
                                    echo '
                                        ...
                                        echo '
                                            ...
                                            echo '
                                                <div class="col m3">
                                                    <img class="galeri materialboxed" data-caption="'.indoDate($row['tgl_diterima']).'" src="./asset/img/pdf.png"/>
                                                    <a class="btn light-green darken-1" href="?page=gsmf&act=fsmf&id_suratf='.$row['id_suratft'].'">Lihat Detail File</a>
                                                </div>';
                                        }
                                    }
                                }
                        ...
                        if($pg > 1){
                            $prev = $pg - 1;
                            echo '<li><a href="?page=gsmf&pg=1"><i class="material-icons md-48">first_page</i></a></li>
                                  <li><a href="?page=gsmf&pg='.$prev.'"><i class="material-icons md-48">chevron_left</i></a></li>';
                        } else {
                        ...
                        for ($i = 1; $i <= $cpg; $i++) {
                            if ((($i >= $pg - 3) && ($i <= $pg + 3)) || ($i == 1) || ($i == $cpg)) {
                                if ($i == $pg) echo '<li class="active waves-effect waves-dark"><a href="?page=gsmf&pg='.$i.'"> '.$i.' </a></li>';
                                else echo '<li class="waves-effect waves-dark"><a href="?page=gsmf&pg='.$i.'"> '.$i.' </a></li>';
                            }
                        }
                        ...
                        if($pg < $cpg){
                            $next = $pg + 1;
                            echo '<li><a href="?page=gsmf&pg='.$next.'"><i class="material-icons md-48">chevron_right</i></a></li>
                                  <li><a href="?page=gsmf&pg='.$cpg.'"><i class="material-icons md-48">last_page</i></a></li>';
                        } else {
