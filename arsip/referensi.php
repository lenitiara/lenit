<?php
    ...
    if(empty($_SESSION['admin'])){
        ...
        if(isset($_REQUEST['act'])){
            ...
            $query = mysqli_query($koneksi, "SELECT referensi FROM tbl_sett");
            ...
            $pg = @$_GET['pg'];
                        ...
                        <div class="z-depth-1">
                            <nav class="secondary-nav">
                                <div class="nav-wrapper blue-grey darken-1">
                                    <div class="col m7">
                                        <ul class="left">
                                            <li class="waves-effect waves-light hide-on-small-only"><a href="?page=ref" class="judul"><i class="material-icons">class</i> Kategori Surat</a></li>';
                                            if($_SESSION['admin'] == 1 || $_SESSION['admin'] == 4 || $_SESSION['admin'] == 5 || $_SESSION['admin'] == 6){
                                                echo '<li class="waves-effect waves-light"><a href="?page=ref&act=add"><i class="material-icons md-24">add_circle</i> Tambah Kategori</a></li>
                ...
                $cari = mysqli_real_escape_string($koneksi, $_REQUEST['cari']);
                    ...
                    <div class="col m12" id="colres">
                        <table class="bordered" id="tbl">
                            <thead class="blue lighten-4" id="head">
                                <tr>
                                    ...
                                    <th width="18%">  <span class="right"><i class="material-icons" style="color: #333;">settings</i></span></th>
                                </tr>
                            </thead>
                            <tbody>';

                            //script untuk menampilkan data
                            $query = mysqli_query($koneksi, "SELECT * FROM tbl_klasifikasi WHERE uraian LIKE '%$cari%' ORDER BY id_klasifikasi DESC LIMIT 15");
                            if(mysqli_num_rows($query) > 0){
                                ...
                                echo '
                                    <tr>
                                        ...
                                        if($_SESSION['admin'] != 1 AND $_SESSION['admin'] != 4 AND $_SESSION['admin'] != 5 AND $_SESSION['admin'] != 6){
                                ...
                                <table class="bordered" id="tbl">
                                    <thead class="blue lighten-4" id="head">
                                        <tr>
                                            ...
                                            <th width="30%">Nama</th>
                                            <th width="42%">Uraian</th>
                                            <th width="18%"> <span class="right tooltipped" data-position="left" data-tooltip="Atur jumlah data yang ditampilkan"><a class="modal-trigger" href="#modal"><i class="material-icons" style="color: #333;">settings</i></a></span></th>

                                                <div id="modal" class="modal">
                                                    <div class="modal-content white">
                                                        <h5>Jumlah data yang ditampilkan per halaman</h5>';
                                                        $query = mysqli_query($koneksi, "SELECT id_sett,referensi FROM tbl_sett");
                                                                ...
                                                                <div class="input-field col s12">
                                                                    ...
                                                                    <div class="modal-footer white">
                                                                        ...
                                                                        if(isset($_REQUEST['simpan'])){
                                                                            ...
                                                                            $query = mysqli_query($koneksi, "UPDATE tbl_sett SET referensi='$referensi',id_user='$id_user' WHERE id_sett='$id_sett'");
                                                                            if($query == true){
                                    ...
                                    //script untuk menampilkan data
                                    $query = mysqli_query($koneksi, "SELECT * FROM tbl_klasifikasi ORDER BY id_klasifikasi DESC LIMIT $curr, $limit");
                                    if(mysqli_num_rows($query) > 0){
                                        while($row = mysqli_fetch_array($query)){
                                          echo '
                                          <tr><td>'.$row['kode'].'</td>
                        ...
                        $query = mysqli_query($koneksi, "SELECT * FROM tbl_klasifikasi");
