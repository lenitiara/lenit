    ...
    if(empty($_SESSION['admin'])){
        ...
        if(isset($_REQUEST['submit'])){
                                    ...
                                    if(!preg_match("/^[a-zA-Z0-9., -]*$/", $indeks)){
                                        ...
                                        if(!preg_match("/^[0-9.-]*$/", $tgl_surat)){
                                            ...
                                            if(!preg_match("/^[a-zA-Z0-9.,()\/ -]*$/", $keterangan)){
                                                ...
                                                $cek = mysqli_query($koneksi, "SELECT * FROM tbl_surat_masuk_ft WHERE no_surat='$no_surat'");
                                                    ...
                                                    if($file != ""){
                                                        ...
                                                        if(in_array($eks, $ekstensi) == true){
                                                            if($ukuran < 2500000){
                                                                ...
                                                                $query = mysqli_query($koneksi, "INSERT INTO tbl_surat_masuk_ft (no_agenda,no_surat,asal_surat,isi,kode,indeks,tgl_surat,
                                                        ...
                                                        $query = mysqli_query($koneksi, "INSERT INTO tbl_surat_masuk_ft (no_agenda,no_surat,asal_surat,isi,kode,indeks,tgl_surat, tgl_diterima,file,keterangan,id_user)
                ...
                <div class="col s12">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper blue-grey darken-1">
                            <ul class="left">
                                <li class="waves-effect waves-light"><a href="?page=tsmf&act=addf" class="judul"><i class="material-icons">mail</i> Tambah Data Surat Masuk</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
            ...
            <div class="row jarak-form">
                ...
                <!-- Form START -->
                <form class="col s12" method="POST" action="?page=tsmf&act=addf" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="input-field col s6">
                            ...
                            echo '<input id="no_agenda" type="number" class="validate" name="no_agenda" value="';
                                $sql = mysqli_query($koneksi, "SELECT no_agenda FROM tbl_surat_masuk_ft");
                                $no_agenda = "1";
                    ...
                    <div class="row">
                        ...
                        <div class="col 6">
                            <a href="?page=tsmf" class="btn-large deep-orange waves-effect waves-light">BATAL <i class="material-icons">clear</i></a>
                        </div>
                    </div>
