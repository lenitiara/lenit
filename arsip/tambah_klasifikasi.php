                    ...
                    if(!preg_match("/^[a-zA-Z0-9. ]*$/", $kode)){
                        ...
                        if(!preg_match("/^[a-zA-Z0-9.,\/ -]*$/", $nama)){
                            ...
                            if(!preg_match("/^[a-zA-Z0-9.,()\/\r\n -]*$/", $uraian)){
                                ...
                                $cek = mysqli_query($koneksi, "SELECT * FROM tbl_klasifikasi WHERE kode='$kode'");
                                ...
                                if($result > 0){
                                    ...
                                    $query = mysqli_query($koneksi, "INSERT INTO tbl_klasifikasi(kode,nama,uraian,id_user) VALUES('$kode','$nama','$uraian','$id_user')");
