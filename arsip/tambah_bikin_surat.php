        ...
        if(isset($_REQUEST['submit'])){
            ...
            if($_REQUEST['no_urut'] == "" || $_REQUEST['no_surat'] == "" || $_REQUEST['lampiran'] == "" || $_REQUEST['perihal'] == ""
                ...
                if(!preg_match("/^[0-9]*$/", $no_urut)){
                    $_SESSION['no_urut'] = 'Form Nomor Urut harus diisi angka!';
                    echo '<script language="javascript">window.history.back();</script>';
                } else {
                    ...
                    if(!preg_match("/^[a-zA-Z0-9.\/ -]*$/", $no_surat)){
                        ...
                        if(!preg_match("/^[a-zA-Z0-9.,() \/ -]*$/", $lampiran)){
                            $_SESSION['lampiran'] = 'Form Lampiran hanya boleh mengandung karakter huruf, angka, spasi, titik(.), koma(,), minus(-),kurung() dan garis miring(/)';
                            echo '<script language="javascript">window.history.back();</script>';
                        } else {
                            ...
                            if(!preg_match("/^[a-zA-Z0-9.,_()%&@\/\r\n -]*$/", $perihal)){
                                ...
                                if(!preg_match("/^[a-zA-Z0-9., ]*$/", $isi)){
                                    $_SESSION['isi'] = 'Form Isi Surat hanya boleh mengandung karakter huruf, angka, spasi, titik(.) dan koma(,)';
                                    echo '<script language="javascript">window.history.back();</script>';
                                } else {                                    
                                        if(!preg_match("/^[0-9.-]*$/", $tgl_surat)){
                                            ...
                                            if(!preg_match("/^[a-zA-Z0-9.,()\/ -]*$/", $keterangan)){
                                                ...
                                                $cek = mysqli_query($koneksi, "SELECT * FROM tbl_buat_surat WHERE no_surat='$no_surat'");
                                                     ...
                                                     if($file != ""){
                                                        ...
                                                        if(in_array($eks, $ekstensi) == true){
                                                            if($ukuran < 2500000){
                                                                ...
                                                                $query = mysqli_query($koneksi, "INSERT INTO tbl_buat_surat(no_urut,no_surat,lampiran,perihal,isi,tgl_surat,tujuan,
                                                                   keterangan,id_user)
                                                                        VALUES('$no_urut','$no_surat','$lampiran','$perihal','$isi','$tgl_surat','$tujuan',NOW(),'$keterangan','$id_user')");
                ...
                <div class="col s12">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper blue-grey darken-1">
                            <ul class="left">
                                <li class="waves-effect waves-light"><a href="?page=tms&act=tbs" class="judul"><i class="material-icons">mail</i> Buat Surat</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
            ...
            <div class="row jarak-form">
                ...
                <!-- Form START -->
                <form class="col s12" method="POST" action="?page=tms&act=tbs" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="input-field col s6">
                            ...
                            <?php
                            echo '<input id="no_urut" type="number" class="validate" name="no_urut" value="';
                                $sql = mysqli_query($koneksi, "SELECT no_urut FROM tbl_buat_surat");
                                $no_urut = "1";
                                ...
                                $counter = 0;
                                while(list($no_urut) = mysqli_fetch_array($sql)){
                                    if (++$counter == $result) {
                                        $no_urut++;
                                        echo $no_urut;
                                    }
                                ...
                                if(isset($_SESSION['no_urut'])){
                                    $no_urut = $_SESSION['no_urut'];
                                    echo '<div id="alert-message" class="callout bottom z-depth-1 red lighten-4 red-text">'.$no_urut.'</div>';
                    ...
                    <div class="row">
                        ...
                        <div class="col 6">
                            <a href="?page=tms" class="btn-large red waves-effect waves-light">BATAL <i class="material-icons">clear</i></a>
                        </div>
                    </div>
