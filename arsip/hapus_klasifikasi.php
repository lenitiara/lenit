<?php
    ...
    if(empty($_SESSION['admin'])){
        ...
        $id_klasifikasi = mysqli_real_escape_string($koneksi, $_REQUEST['id_klasifikasi']);
        $query = mysqli_query($koneksi, "SELECT * FROM tbl_klasifikasi WHERE id_klasifikasi='$id_klasifikasi'");
    	...
    	if(mysqli_num_rows($query) > 0){
          ...
          <!-- Row form Start -->
        	...
        	if(isset($_REQUEST['submit'])){
                ...
                $query = mysqli_query($koneksi, "DELETE FROM tbl_klasifikasi WHERE id_klasifikasi='$id_klasifikasi'");
