<?php
    ...
    if(empty($_SESSION['admin'])){
        ...
        if($_SESSION['admin'] != 1 AND $_SESSION['admin'] != 5 AND $_SESSION['admin'] != 6){
        ...
        if(isset($_REQUEST['act'])){
            ...
            $query = mysqli_query($koneksi, "SELECT surat_keluar FROM tbl_sett");
                                    ...
                                    <div class="col m7">
                                        <ul class="left">
                                            ...
                                            <li class="waves-effect waves-light">
                                                <a href="?page=tsk&act=add"><i class="material-icons md-24">add_circle</i> Membuat Surat</a>
                                            </li>
                                        </ul>
                                    </div>
                ...
                <?php
                    ...
                    $cari = mysqli_real_escape_string($koneksi, $_REQUEST['cari']);
                        ...
                        <table class="bordered" id="tbl">
                                    ...
                                    <th width="16%">Tindakan <span class="right tooltipped" data-position="left" data-tooltip="Atur jumlah data yang ditampilkan"><a class="modal-trigger" href="#modal"><i class="material-icons" style="color: #333;">settings</i></a></span></th>
                                        ...
                                        <div id="modal" class="modal">
                                            <div class="modal-content white">
                                                ...
                                                $query = mysqli_query($koneksi, "SELECT id_sett,surat_keluar FROM tbl_sett");
                                                        ...
                                                        <div class="input-field col s12">
                                                            ...
                                                            <div class="modal-footer white">
                                                                ...
                                                                if(isset($_REQUEST['simpan'])){
                                                                    ...
                                                                    $query = mysqli_query($koneksi, "UPDATE tbl_sett SET surat_keluar='$surat_keluar',id_user='$id_user' WHERE id_sett='$id_sett'");
                                                                    if($query == true){
                            ...
                            //script untuk mencari data
                            $query = mysqli_query($koneksi, "SELECT * FROM tbl_surat_keluar ORDER by id_surat DESC LIMIT $curr, $limit");
                            if(mysqli_num_rows($query) > 0){
                                $no = 1;
                                while($row = mysqli_fetch_array($query)){
                                  echo '
                                  <tr>
                                    ...
                                    if($_SESSION['id_user'] != $row['id_user'] AND $_SESSION['id_user'] != 1 AND $_SESSION['id_user'] != 4 AND $_SESSION['id_user'] != 5){
                                        echo '<button class="btn small blue-grey waves-effect waves-light"><i class="material-icons">error</i> No Action</button>';
                                    } else {
                                      echo '<a class="btn small blue waves-effect waves-light" href="?page=tsk&act=edit&id_surat='.$row['id_surat'].'">
                                                <i class="material-icons">edit</i> EDIT</a>
                    ...
                    $query = mysqli_query($koneksi, "SELECT * FROM tbl_surat_keluar");
