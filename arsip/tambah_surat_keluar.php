                                ...
                                if(!preg_match("/^[a-zA-Z0-9., ]*$/", $nkode)){
                                    ...
                                    if(!preg_match("/^[0-9.-]*$/", $tgl_surat)){
                                        ...
                                        if(!preg_match("/^[a-zA-Z0-9.,()\/ -]*$/", $keterangan)){
                                            ...
                                            $cek = mysqli_query($koneksi, "SELECT * FROM tbl_surat_keluar WHERE no_surat='$no_surat'");
                                                ...
                                                if($file != ""){
                                                    ...
                                                    if(in_array($eks, $ekstensi) == true){
                                                        if($ukuran < 2500000){
                                                            ...
                                                            $query = mysqli_query($koneksi, "INSERT INTO tbl_surat_keluar(no_agenda,tujuan,no_surat,isi,kode,tgl_surat,
                ...
                <div class="col s12">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper blue-grey darken-1">
                            <ul class="left">
                                <li class="waves-effect waves-light"><a href="?page=tsk&act=add" class="judul"><i class="material-icons">drafts</i> Membuat Surat Keluar</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
                    ...
                    <div class="row">
                        <div class="input-field col s6">
                            ...
                            echo '<input id="no_agenda" type="number" class="validate" name="no_agenda" value="';
                                $sql = mysqli_query($koneksi, "SELECT no_agenda FROM tbl_surat_keluar");
                                $no_agenda = "1";
