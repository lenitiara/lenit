<?php
    ...
    if(empty($_SESSION['admin'])){
        ...
        if(isset($_REQUEST['submit'])){
                        ...
                        if(!preg_match("/^[0-9 -]*$/", $batas_waktu)){
                            ...
                            if(!preg_match("/^[a-zA-Z0-9.,()%@\/ -]*$/", $catatan)){
                                ...
                                if(!preg_match("/^[a-zA-Z0 ]*$/", $sifat)){
                                    ...
                                    $query = mysqli_query($koneksi, "UPDATE tbl_disposisi SET tujuan='$tujuan', isi_disposisi='$isi_disposisi', sifat='$sifat', batas_waktu='$batas_waktu', catatan='$catatan', id_surat='$id_surat', id_user='$id_user' WHERE id_disposisi='$id_disposisi'");
            ...
            $id_disposisi = mysqli_real_escape_string($koneksi, $_REQUEST['id_disposisi']);
            $query = mysqli_query($koneksi, "SELECT * FROM tbl_disposisi WHERE id_disposisi='$id_disposisi'");
